          ...
          <div className="border-8 md:border-[20px]  border-new/50 h-full pb-20">
            <div className="-mt-36 md:-mt-24 md:px-16 md:flex mx-4">
              ...
              <div className="mt-10 md:mt-28 md:w-[800px] md:ml-10 text-[20px] flex flex-col justify-between space-y-10">
                <h1>
                  ...
                  penting untuk terus berkembang di dunia industri dan teknologi
                  4.0 yang sangat mudah berubah saat ini. Sebagai seseorang yang
                  berkarier di bidang IT dan peduli terhadap perkembangan
                  teknologi, saya terkadang merasa agak sedikit “pesimis” di
            ...
            <div className="md:px-[125px] text-xl px-4 md:text-xl mt-10 space-y-4">
              ...
              <h1 data-aos="fade-left">
                ...
                oleh sang penjual. Meningkatnya pembeli di e-commerce tak jarang
                menyebabkan kesulitan pengiriman yang dianggap cukup rumit. Hal
                ini juga menyebabkan performa kurang produktif yang bisa dialami
                penjual dan kekurangan peminat pada pembeli. Lebih gawatnya,
                bisa-bisa rating kita akan menurun.
              </h1>
              <h1 data-aos="fade-right">
                Berbicara soal e-commerce ataupun online shop, jasa kirim jadi
                salah satu yang paling penting selain barang yang dihadirkan. Di
                sini, jasa kirim berperan utama untuk menyampaikan barang dengan
                kondisi aslinya yaitu wajib baik. Sebagai penjual, kamu wajib
                nih untuk menentukan jasa kirim yang terbukti baik sesuai rating
                dan service-nya.
              </h1>
              <h1 data-aos="fade-left">
                Sebagai kacamata konsumen, pasti kamu juga menginginkan jasa
                kirim yang terbaik untuk memastikan keselamatan barang yang kamu
                beli secara online. Sebagai konsumen yang baik pula, pasti dong
                kamu akan memerlukan pertimbangan lain seperti sistem
                pembayaran, layanan, hingga sistem otomatis, serta bantuan baik
              ...
              <div className="md:flex space-x-2 items-center">
                ...
                <h1>
                  ...
                  cenderung lebih suka jika ada sistem yang mudah dimengerti dan
                  bisa digunakan dengan cepat, maka dari itu muncullah sistem
                  pembayaran COD (Cash on Delivery) yang memudahkan konsumen.
                  Singkatnya, sistem pembayaran COD dilakukan setelah barang
                  sampai, jadi layaknya belanja offline namun jika menggunakan
                  sistem ini kamu cukup menunggu di rumah dan membayar barang
                  sesuai harganya ketika sudah sampai.
                </h1>
              </div>
              <h1>
              ...
              <div className="bg-gradient-to-r from-new to-neww text-white w-full h-fit py-10 md:flex md:flex-row items-center justify-between space-x-10 md:px-10 text-2xl flex flex-col rounded-lg md:rounded-full">
                ...
                <div className="space-y-5">
                  <h1>
                    ...
                    maupun Non-COD untuk memudahkan kamu yang dikembangkan oleh
                    PT. Selalu Siap Solusi.
                  </h1>
                  <h1>
                    Jadi, dapat disimpulkan bahwa KiriminAja dapat jadi inovasi
                    dan solusi untuk membantuu UMKM, pebisnis online, hingga
                    kamu yang tak punya bisnis pun bisa jika ingin mengirimkan
                    paket lho, keren kan!
                  </h1>
                </div>
              </div>
