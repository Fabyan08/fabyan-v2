    ...
    <>
      ...
      >
        ...
        <div className="relative z-40 mx-4 ">
          ...
          <div className="flex items-center justify-center">
            <div className="bg-white  flex items-center justify-center shadow-xl rounded-full w-[900px] h-20  space-x-4">
              <ul className="flex space-x-3  md:space-x-4 items-center justify-center font-semibold text-sm md:text-lg">
                <li>
                  <a
                    href=""
      ...
      <div className="absolute z-20 bg-slate-100 w-full px-4 md:px-24 h-[2000px]  pt-20">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-2xl font-bold text-slate-600">Recent Post</h1>
        </div>
        ...
        <div className="mt-20">
          <div className="flex items-center space-x-3">
            <hr className="border-2 rounded-md border-primary h-5 " />
            <h1 className="text-2xl font-bold text-slate-600">Must Read</h1>
          </div>{" "}
          <div className="grid md:grid-cols-3 space-y-10 md:space-y-0 mt-10">
            <div className=" w-96 space-y-2 hover:scale-110 md:px-0 px-5 duration-150 hover:bg-blue-100  hover:p-2 hover:rounded-xl">
              ...
              <h1 className="text-xl text-primary font-bold">Development</h1>
