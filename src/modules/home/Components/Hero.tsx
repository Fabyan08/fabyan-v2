...
const Hero = () => {
  return (
    <header className="bg-header w-full relative z-10 md:h-screen h-[500px] bg-cover bg-center">
      <div className="bg-gradient-to-b from-white/20  to-white/80 md:h-screen h-[500px]">
