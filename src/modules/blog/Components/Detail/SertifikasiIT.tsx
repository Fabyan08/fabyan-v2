                  ...
                  >
                    ...
                    <div className="p-5 ">
                      ...
                      <h1 className="text-xl  mt-2">
                        ...
                        Profesi (BNSP). Sertifikast profesi adalah sertifikasi kerja yang diperlukan untuk mendapatkan / meningkatkan komppetensi tertentu.
                      </h1>
                      <h1 className="text-xl  mt-2">
                       ...
                       saya sangat tertarik untuk mempelajari apasih pentingnya sertifikasi profesi khususnya di bidang IT dan profesional nanti🤔
                      </h1>
                    </div>
                  </div>
                </div>
