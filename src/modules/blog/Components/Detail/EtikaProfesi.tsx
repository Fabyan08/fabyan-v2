...
"
            ...
            <div className="border-8 md:border-[20px]  border-[#FF7F3E]/50 h-full pb-20">
              ...
              <div className="md:px-[125px] text-xl px-4 md:text-xl mt-10 space-y-4">
                ...
                <h1>
                  <b>Ciri-ciri profesi emang ada?</b>
                  <br />• Asosiasi Profesional . Pendidikan yang Ekstensi Ujian
                  Kompetensi Pelatihan institutional Lisensi Kode etik • Status
                  dan imbalan
                  <div className="flex items-center justify-center">
                    <div className="md:flex space-y-2 md:space-y-0  md:space-x-5 justify-center">
                      <div className="bg-new w-full md:w-60 h-full py-2 md:h-72 hover:shadow-lg hover:shadow-neww hover:-translate-y-10 duration-150 rounded-lg text-white">
                        ...
                        <h1 className="px-5 mt-4 text-center">
                          ...
                          bahkan kamu dapat memanfaatkan bantuan atau support
                          ini tiap hari 24/7 lho!
                        </h1>
                      </div>
                      <div className="bg-new w-full md:w-60 h-full py-2 md:h-72 hover:shadow-lg hover:shadow-neww hover:-translate-y-10 duration-150 rounded-lg text-white">
                      ...
                      <div className="bg-new w-full md:w-60 h-full py-2 md:h-72 hover:shadow-lg hover:shadow-neww hover:-translate-y-10 duration-150 rounded-lg text-white">
                        ...
                        <h1 className="px-5 text-[16px] mt-4 text-center">
                          Layanan kurir seperti seperti pengiriman bisa
                          dilakukan secara instan dan di hari yang sama. Ataupun
                          kamu bisa memilih regular/ekonomis/kargo juga.
                        </h1>
                      </div>
                      <div className="bg-new w-full md:w-60 h-full py-2 md:h-72 hover:shadow-lg hover:shadow-neww hover:-translate-y-10 duration-150 rounded-lg text-white">
                        <div className="bg-white mx-5 mt-2 text-[#FF7F3E] text-center rounded-lg font-bold">
                        ...
                        <h1 className="px-5 mt-4 text-[17px] text-center">
                          Layaknya berikan kemudahan, sistem cetak resi,
                          tracking, hingga laporan bisa kamu dapatkan secara
                          lengkap dan pastinya langsung karena sudah otomatis.
                        </h1>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex  space-x-4 items-center">
                    <h1 className="text-2xl md:text-4xl font-bold">
                      ...
                      <span className="text-[#FF7F3E]"> KiriminAja? </span>{" "}
                    </h1>
                ...
                <div className="mt-1 space-y-6">
                  ...
                  <h1>
                    ...
                    yang disedikan. Klik{" "}
                    <span className="text-[#FF7F3E] underline">
                      <a
                        target="_blank"
                        rel="noreferrer"
              ...
              <div className="relative  text-slate-700  text-2xl px-4 md:px-16">
                ...
                <div className=" mt-6 text-[#FF7F3E] items-center space-x-2 mb-5">
